      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '32px' }}>
        ...
        <div style={{ display: 'flex', gap: '12px' }}>
          <button 
            ...
            style={{ padding: '0 20px', height: '42px', display: 'flex', alignItems: 'center', gap: '8px', background: 'var(--card-bg)', color: 'var(--slate-700)', border: '1px solid var(--border-main)', fontSize: '13px', fontWeight: '600' }}
          >
